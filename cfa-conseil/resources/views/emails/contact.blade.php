<div  style="max-width: 600px; margin: 0 auto; background-color: #ffffff; overflow: hidden; border: 1px solid #D1DCED; box-shadow: 4px 4px 0 0 #D1DCED; border-radius: 0.5rem;">
    ...
    <div class="content" style="padding: 20px;">
        <div style="margin-bottom: 24px;">
            ...
            <div style="display: flex; align-items: center; gap: 8px; font-family: 'Inter', sans-serif; font-size: 16px; font-weight: 500; color: #111827;">{{ $data['name'] }} <span style=" color: #252550; background-color: #CEDCED; border: 1px solid #e5e7eb; padding: 2px 4px; border-radius: 6px; font-size: .9em;">{{ $data['email'] }}</span></div>
        </div>
